...
echo "================================================================================"
echo "Evolving..."
cmd="bash ../../PANPROVA.sh --igenome ../genomes/mycoplasma_genitalium_G37.peg --hgtpool hgt_pool --trans-table 4 --oprefix ./example  -phylo example.tree --number-of-fusion-cycles 0 --gene-fusion-prob 0"
echo $cmd
date
/usr/bin/time -f"%E %M" $cmd
date
